...
public class SwitchLoginButton extends ScreenComponent {

	public SwitchLoginButton(int x, int y, BufferedImage sprite, BufferedImage selectedSprite, Screen screen) {
		super(x, y, sprite);
